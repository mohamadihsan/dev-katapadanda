...
<html lang="en">
  <head>
	...
	<!-- Bootstrap -->
    <link href="{{ asset('assets_frontend/css/bootstrap.min.css') }}" rel="stylesheet" type="text/css" media="all" />
	<!-- Font -->
    ...
    <link rel="stylesheet" href="{{ asset('assets_frontend/css/owl.theme.css') }}">
	<!-- Magnific Popup -->
    <link rel="stylesheet" href="{{ asset('assets_frontend/css/magnific-popup.css') }}">
	<!-- Full Page Animation -->
    <link rel="stylesheet" href="{{ asset('assets_frontend/css/animsition.min.css') }}">
	<!-- Ionic Icons -->
    <link rel="stylesheet" href="{{ asset('assets_frontend/css/ionicons.min.css') }}"> 
	<!-- Main Style css -->
    <link href="{{ asset('assets_frontend/css/style.css') }}" rel="stylesheet" type="text/css" media="all" />
  </head>
  <body>
...
<!-- Jquery and Js Plugins -->
  <script type="text/javascript" src="{{ asset('assets_frontend/js/jquery-2.1.1.js') }}"></script>
  <script type="text/javascript" src="{{ asset('assets_frontend/js/bootstrap.min.js') }}"></script>
  <script type="text/javascript" src="{{ asset('assets_frontend/js/plugins.js') }}"></script>
  <script type="text/javascript" src="{{ asset('assets_frontend/js/menu.js') }}"></script>
  <script type="text/javascript" src="{{ asset('assets_frontend/js/custom.js') }}"></script>
  </body>
</html>
